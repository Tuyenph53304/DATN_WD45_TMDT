        ...
        <div class="col-lg-4 col-md-6">
          <div class="card product-card h-100">
            <div class="position-relative overflow-hidden" style="height: 240px;">
              <img src="{{ $defaultVariant->image ?? 'https://images.unsplash.com/photo-1525547719571-a2d4ac8945e2?w=400&h=300&fit=crop' }}" class="card-img-top w-100 h-100" alt="{{ $product->name }}" style="object-fit: cover;">
            ...
            <div class="card-body d-flex flex-column">
              ...
              <div class="price-container mb-3">
                @if($minPrice && $maxPrice && $minPrice != $maxPrice)
                  <span class="price-new">{{ number_format($minPrice) }}₫ - {{ number_format($maxPrice) }}₫</span>
              ...
              <div class="product-actions">
                ...
                <button class="btn btn-primary btn-sm flex-grow-1 add-to-cart-btn" data-variant-id="{{ $defaultVariant->id }}">
