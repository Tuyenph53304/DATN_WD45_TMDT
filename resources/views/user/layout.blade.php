                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-6 mb-4">
                        ...
                        <ul class="list-unstyled">
                            <li class="mb-2"><a href="{{ route('home') }}" class="text-muted text-decoration-none"><i class="bi bi-house me-1"></i> Trang chủ</a></li>
                            <li class="mb-2"><a href="{{ route('products.index') }}" class="text-muted text-decoration-none"><i class="bi bi-laptop me-1"></i> Sản phẩm</a></li>
                            <li class="mb-2"><a href="{{ route('about') }}" class="text-muted text-decoration-none"><i class="bi bi-info-circle me-1"></i> Giới thiệu</a></li>
                            <li class="mb-2"><a href="{{ route('vouchers.index') }}" class="text-muted text-decoration-none"><i class="bi bi-tag me-1"></i> Khuyến mãi</a></li>
                            <li class="mb-2"><a href="{{ route('news.index') }}" class="text-muted text-decoration-none"><i class="bi bi-newspaper me-1"></i> Tin tức</a></li>
                        </ul>
                    </div>
