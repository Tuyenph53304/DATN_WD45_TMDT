    ...
    <div class="w-full max-w-md">
        <div class="bg-white dark:bg-[#161615] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-lg p-8">
            <div class="mb-6">
                ...
                <p class="text-sm text-[#706f6c] dark:text-[#A1A09A]">Nhập thông tin để đăng nhập vào tài khoản của bạn</p>
            </div>
            ...
            <form method="POST" action="{{ route('login.post') }}" class="space-y-4">
                ...
                <div class="flex items-center">
                    <input
                        ...
                        id="remember"
                        name="remember"
                        class="w-4 h-4 text-[#1b1b18] dark:text-[#EDEDEC] bg-white dark:bg-[#0a0a0a] border-[#e3e3e0] dark:border-[#3E3E3A] rounded-sm focus:ring-2 focus:ring-[#19140035] dark:focus:ring-[#62605b]"
                    >
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-[#706f6c] dark:text-[#A1A09A]">
                    Chưa có tài khoản?
                    <a href="{{ route('register') }}" class="text-[#f53003] dark:text-[#FF4433] font-medium underline underline-offset-4 hover:text-[#d42903] dark:hover:text-[#ff5533]">
                        Đăng ký ngay
                    </a>
                </p>
            </div>
