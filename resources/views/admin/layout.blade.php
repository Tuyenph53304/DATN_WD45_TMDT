...
<html lang="en">
  ...
  <head>
    ...
    <meta name="title" content="@yield('title', 'AdminLTE v4 | Dashboard')" />
    ...
    <!--begin::Tailwind CSS (for user management views)-->
            ...
            <li class="nav-item dropdown user-menu">
              ...
              <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                ...
                <li class="user-header text-bg-primary">
                  ...
                  />
                  <p>
                    {{ Auth::user()->name ?? 'Alexander Pierce' }} - {{ Auth::user()->role ?? 'Web Developer' }}
